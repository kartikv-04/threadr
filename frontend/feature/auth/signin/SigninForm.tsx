...
const SigninForm = () => {
    ...
    function submitForm(data: SignInPayload) {
        console.log("Submitted Data for signin", data);
        mutate(data, {
            // Onsuccess
            onSuccess: (response) => {
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input id="password" name="password" value={formData.password} onChange={handleInput} type="password" required />
                            </div>
                        </div>
